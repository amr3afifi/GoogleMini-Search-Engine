...
--
-- Table structure for table `doc_url`
--
CREATE TABLE `doc_url` (
...
ALTER TABLE `images`
  ADD CONSTRAINT `fk_images_url` FOREIGN KEY (`url_id`) REFERENCES `urls` (`id`);

ALTER TABLE `doc_url`
  ADD CONSTRAINT `fk_docurl_url` FOREIGN KEY (`url_id`) REFERENCES `urls` (`id`);

ALTER TABLE `doc_url`
  ADD CONSTRAINT `fk_docurl_doc` FOREIGN KEY (`doc_id`) REFERENCES `documents` (`id`);
